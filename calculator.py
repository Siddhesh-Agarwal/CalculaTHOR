...
class Calculator:
    def __init__(self, master):
        ...
        top_frame = tk.Frame(
            master, width=650, height=20, bd=4, relief="flat", bg="gray4"
        )
        top_frame.pack(side=tk.TOP)

        bottom_frame = tk.Frame(
            master, width=650, height=470, bd=2, relief="flat", bg="gray4"
        )
        ...
        self.btn_del = tk.Button(
            bottom_frame, btn_params, text="C", command=self.btn_clear
        )
        self.btn_del.configure(
            activebackground="#B22222", bg="#B22222", foreground="#FFFFFF"
        )
        self.btn_del.grid(row=0, column=1)

        self.btn_clear_all = tk.Button(
            bottom_frame, btn_params, text="CE", command=self.btn_clear_all
        )
        ...
        self.btn_reciprocal = tk.Button(
            bottom_frame, btn_params, text="1/x", command=lambda: self.btn_click("1/")
        )
        self.btn_reciprocal.grid(row=0, column=3)

        self.btn_open_brack = tk.Button(
            bottom_frame, btn_params, text="(", command=lambda: self.btn_click("(")
        )
        self.btn_open_brack.grid(row=0, column=4)

        self.btn_close_brack = tk.Button(
            bottom_frame, btn_params, text=")", command=lambda: self.btn_click(")")
        )
        ...
        self.btn_clear.configure(
            activebackground="#A5A5A5", bg="#A5A5A5", foreground="black"
        )
        ...
        self.btn_change_sign.configure(
            activebackground="#A5A5A5", bg="#A5A5A5", foreground="black"
        )
        ...
        self.btn_div.configure(
            activebackground="#FB9F10", bg="#FB9F10", foreground="#FFFFFF"
        )
        ...
        self.btn_power = tk.Button(
            bottom_frame, btn_params, text="x^y", command=lambda: self.btn_click("**")
        )
        self.btn_power.grid(row=1, column=3)

        self.btn_e_power = tk.Button(
            bottom_frame, btn_params, text="e^x", command=lambda: self.btn_click("e**")
        )
        self.btn_e_power.grid(row=1, column=4)

        self.btn_10_power = tk.Button(
            bottom_frame,
            btn_params,
            text="10^x",
            command=lambda: self.btn_click("10**"),
        )
        self.btn_10_power.grid(row=1, column=5)

        self.btn_7 = tk.Button(
            bottom_frame, btn_params, text="7", command=lambda: self.btn_click(7)
        )
        self.btn_7.configure(activebackground="#343434", bg="#343434")
        self.btn_7.grid(row=1, column=6)

        self.btn_8 = tk.Button(
            bottom_frame, btn_params, text="8", command=lambda: self.btn_click(8)
        )
        self.btn_8.configure(activebackground="#343434", bg="#343434")
        self.btn_8.grid(row=1, column=7)

        self.btn_9 = tk.Button(
            bottom_frame, btn_params, text="9", command=lambda: self.btn_click(9)
        )
        self.btn_9.configure(activebackground="#343434", bg="#343434")
        self.btn_9.grid(row=1, column=8)

        self.btn_mult = tk.Button(
            bottom_frame, btn_params, text="x", command=lambda: self.btn_click("*")
        )
        self.btn_mult.configure(
            activebackground="#FB9F10", bg="#FB9F10", foreground="#FFFFFF"
        )
        self.btn_mult.grid(row=1, column=9)

        self.btn_Deg = tk.Button(
            bottom_frame, btn_params, text="Deg", command=self.convert_deg
        )
        self.btn_Deg.grid(row=2, column=1)

        self.btn_Rad = tk.Button(
            bottom_frame, btn_params, text="Rad", command=self.convert_rad
        )
        ...
        self.btn_abs = tk.Button(
            bottom_frame, btn_params, text="|x|", command=lambda: self.btn_click("abs(")
        )
        ...
        self.btn_sin = tk.Button(
            ...
            btn_params,
            text="sin",
            command=lambda: self.btn_click(f"sin({convert_constant}*"),
        )
        ...
        self.btn_cos = tk.Button(
            ...
            btn_params,
            text="cos",
            command=lambda: self.btn_click(f"cos({convert_constant}*"),
        )
        self.btn_cos.grid(row=3, column=2)

        self.btn_tan = tk.Button(
            bottom_frame,
            btn_params,
            text="tan",
            command=lambda: self.btn_click(f"tan({convert_constant}*"),
        )
        self.btn_tan.grid(row=3, column=3)

        self.btn_e = tk.Button(
            bottom_frame, btn_params, text="e", command=lambda: self.btn_click("e")
        )
        self.btn_e.grid(row=3, column=4)

        self.btn_log = tk.Button(
            bottom_frame, btn_params, text="log", command=lambda: self.btn_click("log(")
        )
        self.btn_log.grid(row=3, column=5)

        self.btn_1 = tk.Button(
            bottom_frame, btn_params, text="1", command=lambda: self.btn_click(1)
        )
        self.btn_1.configure(activebackground="#343434", bg="#343434")
        self.btn_1.grid(row=3, column=6)

        self.btn_2 = tk.Button(
            bottom_frame, btn_params, text="2", command=lambda: self.btn_click(2)
        )
        self.btn_2.configure(activebackground="#343434", bg="#343434")
        self.btn_2.grid(row=3, column=7)

        self.btn_3 = tk.Button(
            bottom_frame, btn_params, text="3", command=lambda: self.btn_click(3)
        )
        ...
        self.btn_sin_inverse = tk.Button(
            bottom_frame,
            btn_params,
            text="sin-\u00B9",
            command=lambda: self.btn_click(f"{inverse_convert_constant}*asin("),
        )
        self.btn_sin_inverse.grid(row=4, column=1)

        self.btn_cos_inverse = tk.Button(
            bottom_frame,
            btn_params,
            text="cos-\u00B9",
            command=lambda: self.btn_click(f"{inverse_convert_constant}*acos("),
        )
        self.btn_cos_inverse.grid(row=4, column=2)

        self.btn_tan_inverse = tk.Button(
            bottom_frame,
            btn_params,
            text="tan-\u00B9",
            command=lambda: self.btn_click(f"{inverse_convert_constant}*atan("),
        )
        ...
        self.btn_0 = tk.Button(
            bottom_frame, btn_params, text="0", command=lambda: self.btn_click(0)
        )
        self.btn_0.configure(activebackground="#343434", bg="#343434")
        self.btn_0.grid(row=4, column=6)

        self.btn_00 = tk.Button(
            bottom_frame, btn_params, text="00", command=lambda: self.btn_click("00")
        )
        ...
        self.btn_eq = tk.Button(
            bottom_frame, btn_params, text="=", command=self.btn_equal
        )
